...
function resettiFunktio() {
  if (lastClassAdded) {
    document.querySelector(`.${lastClassAdded}`).classList.remove(lastClassAdded);
    lastClassAdded = null;
  }
}
